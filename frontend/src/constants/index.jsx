export const features = [
  {
    ...
    title: "Find with Images & Captions",
    text: "Mindflix lets you search effortlessly using images, captions, or both. Say goodbye to endless scrolling—get precise results instantly.",
    button: {
  ...
  },
  {
    ...
    caption: "Next-Gen AI",
    title: "Search with Drawings",
    text: "Sketch it, upload it, and let Mindflix do the rest. Our AI understands free-hand drawings to help you find exactly what you need at a very fast pace.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Watch the Demo",
    },
...
export const details = [
  {
    ...
    title: "Find with Images",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Find with Captions",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Find with Both",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Find with Sketches",
  },
];
...
export const faq = [
  {
    id: "1",
    question: "How does Mindflix's image and caption search work?",
    answer:
      "Mindflix uses advanced AI to analyze both images and captions, delivering accurate search results instantly. Just upload an image, add a caption, or use both for better accuracy.",
  },
  {
    id: "2",
    question: "Can I search using free-hand drawings?",
    answer:
      "Yes! Mindflix supports sketch-based searches. Simply draw and upload an image, and our AI will find visually similar results for you.",
  },
  {
    id: "3",
    question: "How easy is it to use Mindflix?",
    answer:
      "Mindflix is designed for seamless usage. Whether you're using it for personal or professional needs, it can be used instantaneously.",
  },
  {
    id: "4",
    question: "Does Mindflix support multi-language caption searches?",
    answer:
      "Yes! Mindflix's AI understands multiple languages, allowing you to search using captions in different languages effortlessly.",
  },
  {
    id: "5",
    question: "What file formats does Mindflix support for image search?",
    answer:
      "Mindflix supports common image formats like JPEG, PNG, and WebP. For drawings, it also accepts SVG and BMP formats.",
  },
  {
    id: "6",
    question: "Is there a limit to the number of searches I can perform?",
    answer:
      "No, there is absolutely no limit to the number of searches you perform.",
  },
  {
    id: "7",
    question: "Does Mindflix work on mobile devices?",
    answer:
      "Yes! Mindflix is optimized for both desktop and mobile devices, ensuring a smooth search experience on any platform.",
  },
  {
    id: "8",
    question: "Can I search for similar images without captions?",
    answer:
      "Yes! You can search using just an image, and Mindflix will find visually similar results without requiring a caption.",
  },
  {
    id: "9",
    question: "How accurate is the search for free-hand drawings?",
    answer:
      "Mindflix uses AI-powered sketch recognition to find the closest matching images, making it a powerful tool for creative searches.",
  },
  {
    id: "10",
    question: "Is my uploaded data stored permanently?",
    answer:
      "No, Mindflix processes searches in real-time without storing your images permanently, ensuring privacy and security.",
  },
];
...
export const socials = [
  {
    ...
    url: "https://www.instagram.com/mindflixai",
  },
  {
    id: "1",
    title: "Website",
    icon: "/images/socials/website.svg",
    url: "https://www.mindflix.ai/",
  },
  {
    id: "2",
    title: "LinkedIn",
    icon: "/images/socials/linkedin.svg",
    url: "https://www.linkedin.com/company/mindflix-ai/",
  },
];
